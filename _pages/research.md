...
<br>
{% include figure image_path="/assets/images/pnas.jpg" alt="this is a placeholder image" caption="Models suggest that higher investment in clonality (_G_) is an evolutionarily stable strategy when average seed and pollen dispersal distances are short, and when inbreeding depression (_k_<sub>s<sub>) is high." type=center %}
